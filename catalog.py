...
SKIP_BY_ID = {
    ...
    "bv0000047": "публикация актов XVII века: люди названы по отчеству "
                 "(проверено пробой из шести страниц)",
    "bv0000209": "нормативный сборник: указы и штаты, имён нет "
                 "(проверено пробой из шести страниц)",
    "bv0000210": "нормативный сборник: указы и штаты, имён нет "
                 "(проверено пробой из шести страниц)",
    "bv0000211": "нормативный сборник: указы и штаты, имён нет "
                 "(проверено пробой из шести страниц)",
}
