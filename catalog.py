...
SKIP_BY_ID = {
    ...
    "bx0000205": "проверено пробой из шести страниц: таблицы поселений, "
                 "жители только счётом",
    # Алфавитный указатель поселений: на каждое — число жителей и дворов,
    # епархия и благочиние, окружный суд, следственный и горный участок,
    # почтовый адрес. Проба из шести страниц: личных имён нет, в графе
    # «учрежденія и лица» стоят сокращения заведений («Сел. пр.»,
    # «Кирпичн. зав.», «вод. мел.»). Фамилию искать не в чем, но как
    # справочник по подчинению места том стоит помнить: именно эти
    # графы собираются в places.json руками по другим книгам.
    "bx0000206": "проверено пробой из шести страниц: алфавитные таблицы "
                 "поселений, личных имён нет; как справочник по "
                 "подчинению места — полезен",
}
