...
def catalog_suite():
    ...
    # подряд нельзя. Последние два — тот самый сдвоенный «№ 1» 1911
    # года: порядок по номеру их не различил бы, а по дате различает.
    paper = {n: {"id": n, "title": t} for n, t in [
        ("pn0024000", "Донские областные ведомости: 1912, № 207 (29 сентября)"),
        ("pn0024150", "Донские областные ведомости: 1911, № 81 (15 октября)"),
        ("pn0024070", "Донские областные ведомости: 1911, № 1 (4 января)"),
        ("pn0024276", "Донские областные ведомости: 1911, № 1 (1 января)"),
    ]}
    order = [r["id"] for r in build(paper)["очередь"]["4_газеты"]]
    ok = order == ["pn0024276", "pn0024070", "pn0024150", "pn0024000"]
    bad += not ok
