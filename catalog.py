...
#
# Второе — исторический труд: имена в нём есть, но это повествование о
# войске, а не перечень жителей, и фамилия попадётся в нём разве что
# случайно. Заголовок и здесь не помощник: «История войска Донского»
# нарочно стоит в COSSACK, потому что под то же начало попадают нужные
# сборники документов.
#
